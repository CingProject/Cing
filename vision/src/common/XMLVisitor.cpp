 ...
 *  constructor.
 */
XMLVisitor::XMLVisitor( XMLElement::XMLDocSharedPtr& xmlDoc, XMLElement::XMLElementArray& children, const String& path /*= "NO_PATH"*/ ):
  m_xmlDoc( xmlDoc ), m_children( children ), m_path( path ), TiXmlVisitor() 
{
