 ...
 * 
 */
class GUIManager: public Common::SingletonStatic< GUIManager >
{
public:

	// Required for singleton
	friend class Common::SingletonStatic< GUIManager >;
...
private:
  ...
  QuickGUI::GUIManager* m_quickGUIManager;  ///< Quick gui manager -> used as Quick gui interface
